...
static const char *fonts[]          = {
	"Anka/Coder Narrow:size=10:antialias=true",
...
static const char *cmenucmd[] = { "sh", "/home/heg/.commenu/commenu.sh", NULL };
...
static const char *volupfinecmd[]   = { "wpctl", "set-volume", "@DEFAULT_AUDIO_SINK@", "1%+", "-l", "1.5", NULL }
static const char *voldownfinecmd[] = { "wpctl", "set-volume", "@DEFAULT_AUDIO_SINK@", "1%-", "-l", "1.5", NULL }
*/

static const char *volupcmd[]         = { "volset", "up",   "5%", NULL };
static const char *voldowncmd[]       = { "volset", "down", "5%", NULL };
static const char *volupfinecmd[]     = { "volset", "up",   "1%", NULL };
...
//  	{ MODKEY|ShiftMask,             XK_r,      spawn,          {.v = rvxcmd} },
	// audio
